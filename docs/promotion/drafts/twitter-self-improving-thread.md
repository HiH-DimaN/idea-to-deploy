...
We built a Claude Code plugin with 19 skills. Then we built a system that audits itself -- and it keeps finding real drift we missed.

Here's how the self-improvement loop works. Thread.

## Tweet 2

The plugin: idea-to-deploy. 19 skills + 6 subagents for Claude Code.

Full lifecycle: idea -> architecture -> code -> tests -> review -> deploy.

But the hard part isn't building skills. It's keeping 19 skills, 6 agents, READMEs, badges, and tables in sync.
...
19 skills, 6 subagents, 25+ meta-review gates, 3-tier testing, product discovery (MoSCoW/RICE), safety guardrails, Red/Blue Team security mode.
